...
int g_choice_cancel_b = 0;
int g_choice_is_menu = 0;
...
int g_actor_anim_timer[PCE_MAX_ACTORS];
int g_actor_num_frames[PCE_MAX_ACTORS];
int g_actor_frame_vram_size[PCE_MAX_ACTORS];
